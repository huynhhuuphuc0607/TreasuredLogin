package edu.orangecoastcollege.cs273.treasuredloginphuynh;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // if the user is signed in, go to Treasure Activity
        if (mUser != null)
            goToTreasure();
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            //alert the user the account was created
                            Toast.makeText(LoginActivity.this, "Account created successfully. Please verify account in your email", Toast.LENGTH_SHORT).show();
                            mUser = mAuth.getCurrentUser();
                            mUser.sendEmailVerification();
                        } else {
                            Toast.makeText(LoginActivity.this, "Account already exists. Please sign in, or use different email.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            ...
                            if(mUser.isEmailVerified())
                                goToTreasure();
                            Toast.makeText(LoginActivity.this, "Please verify your account in your email " + mUser.getEmail(), Toast.LENGTH_SHORT).show();
                        }
